...
const columns = ref<QTableColumn[]>([
  { name: 'WORK_TYPE', required: true, label: '작업 유형', field: 'WORK_TYPE', sortable: true },
  { name: 'EQP_ID', required: true, label: '설비 ID', field: 'EQP_ID', sortable: true },
  { name: 'PRODUCT_ID', required: true, label: '제품 ID', field: 'PRODUCT_ID', sortable: true },
  { name: 'LOT_ID', required: true, label: 'LOT ID', field: 'LOT_ID', sortable: true },
  { name: 'LOT_QTY', required: true, label: 'LOT 수량', field: 'LOT_QTY', sortable: true },
  { name: 'STEP_ID', required: true, label: '공정 ID', field: 'STEP_ID', sortable: true },
  { name: 'STEP_NAME', required: true, label: '공정명', field: 'STEP_NAME', sortable: true },
  { name: 'STEP_SEQ', required: true, label: '공정 순서', field: 'STEP_SEQ', sortable: true },
  {
    name: 'START_TIME',
    required: true,
    label: '작업 시작 시간',
  ...
  { name: 'END_TIME', required: true, label: '작업 종료 시간', field: 'END_TIME', sortable: true },
])
